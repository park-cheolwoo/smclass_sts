...
${bdto.bcontent }
      ...
      <div class="button-wrapper">
        <button type="button" class="write" onclick="replyBtn()">답변완료</button>
        <button type="button" class="cancel" onclick="javascript:location.href='/board/blist?page=${page}'">취소</button>
      </div>
    </form>
